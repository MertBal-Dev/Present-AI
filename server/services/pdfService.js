...
async function getImageData(imageUrl) {
  ...
  if (imageUrl.includes('/uploads/')) {
    const [, afterUploads] = imageUrl.split('/uploads/');
    const filePath = path.join(__dirname, '..', 'public', 'uploads', afterUploads); 
    console.log(`[PDF] Yerel dosya aranıyor: ${filePath}`);
    ...
    throw new Error(`Yerel dosya bulunamadı: ${filePath}`);
  }
